 ...
 */
async function extractWithPolicy(conn, remoteZipPath, remoteDir, policy) {
    const script = `
 ...
 */
export async function batchUpload(conn, files, remoteDir, policy) {
...
//# sourceMappingURL=batchUpload.js.map